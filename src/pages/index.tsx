...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`macbook parts inventory `}</title>

        <meta
          name="description"
          content="Macbook Parts Inventory: Your ultimate solution for managing, tracking, and optimizing your Macbook parts inventory with accuracy and efficiency."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtYWNib29rfGVufDB8fHx8MTY5ODA2NTM1NHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@oneor0?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Dmitry Chernyshov`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`macbook parts inventory `}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Macbook Parts Inventory: Your ultimate solution for managing, tracking, and optimizing your Macbook parts inventory with accuracy and efficiency.`}
            </Text>
            <Box
